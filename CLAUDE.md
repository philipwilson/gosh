...
- Builtins (cd, pwd, echo, exit, export, unset, true, false, break, continue, history, jobs, fg, bg) run in-process with redirect support; cd supports `-` (OLDPWD) and updates PWD/OLDPWD
